...
async function fetchUserRepos(accessToken) {
  ...
  // TODO: add a request limiter or circuit-breaker to protect GitHub API calls from DOS at high volume.
...
async function createWorkflow(accessToken, owner, repoName, defaultBranch = 'main') {
  ...
  // TODO: make workflow YAML template configurable and avoid hard-coding test/run commands.
  // TODO: normalize GitHub API errors and return a consistent service error object to controller layer.
  return commit.data;
}
